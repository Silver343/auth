...
export default function TwoFactorAuthenticationForm({ className = '' }: { className?: string }) {
    ...
    const { data, setData, post, errors, reset, clearErrors, delete:destroy } = useForm({
        code: '',
    })
                        ...
                        <div>
                            {qrCode &&
                                <div>
                                    ...
                                    <div className="mt-4 p-2 inline-block bg-white" dangerouslySetInnerHTML={ qrCodeSVG }/>
                                    {setupKey &&
                                        <div className="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                                            <p className="font-semibold">
                    ...
                    <div className="mt-5">
                        {! twoFactorEnabled ? (
                            ...
                            <div>
                                ...
                                {confirming &&
                                    <PrimaryButton type="button" className="me-3" disabled={enabling}>
                                        confirm
                                    </PrimaryButton>
                                }
                                </ConfirmsPassword>
